class InvitationsController < Devise::InvitationsController
    ...
    def edit
        ...
        # @user = self.resource.find_by_invitation_token(params[:invitation_token], true)
        #binding.break
        render :edit
    end
    ...
    protected
      ...
      def invite_resource(&block)
        ...
        # resource_class.invite!(invite_params, current_inviter, tenant, &block)
      end
      ...
      def invite_params
        ...
        #params.require(:invite).permit(:title, :content, :cover_image, :published_at)
